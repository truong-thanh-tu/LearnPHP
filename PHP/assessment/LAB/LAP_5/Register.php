    ...
    <div class="d-flex justify-content-center h-100">
        <div class="user_card">
            ...
            <div class="d-flex justify-content-center form_container">
                <form action="handling-register.php" method="post">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="fullname" name="fullname" class="form-control input_pass" value="" placeholder="full name">
                    </div>
                    <div class="input-group mb-2">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-phone"></i></span>
                        </div>
                        <input type="phone" name="phone" class="form-control input_pass" value="" placeholder="phone number">
                    </div>
